...
scriptName <- ""
mainDir <- gsub("/PROJECT/", "/DATA/", gsub("Scripts", "", getwd()))
outputDir <- paste0(mainDir, "/", scriptName)

dir.create(paste0(outputDir, , "/KnitrFiles"), recursive = TRUE, showWarnings = FALSE)
...
opts_chunk$set(
    ...
    fig.pos = 'H',
    dpi = params$dpi,
    fig.path = paste0(outputDir, , "/KnitrFiles"),
    cache = FALSE,
    cache.path = paste0(outputDir, , "/KnitrFiles")
)
...
### Custom kable function to output table
mykable <- function (
    data, 
